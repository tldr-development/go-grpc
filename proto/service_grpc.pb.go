...
type AddServiceClient interface {
	...
	CloudStorage(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *addServiceClient) CloudStorage(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
type AddServiceServer interface {
	...
	CloudStorage(context.Context, *Request) (*Response, error)
...
func (UnimplementedAddServiceServer) CloudStorage(context.Context, *Request) (*Response, error) {
...
func _AddService_CloudStorage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AddServiceServer).CloudStorage(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}
