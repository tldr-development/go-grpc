...
// Source: swift-protobuf/CompileTests/InternalImportsByDefault/Sources/InternalImportsByDefault/Protos/SomeProtoWithBytes.proto
//
...
struct SomeProtoWithBytes: @unchecked Sendable {
  ...
  var hasSomeBytes: Bool {return self._someBytes != nil}
  /// Clears the value of `someBytes`. Subsequent reads from it will return its default value.
  mutating func clearSomeBytes() {self._someBytes = nil}
  ...
  var hasExtStr: Bool {return self._extStr != nil}
  /// Clears the value of `extStr`. Subsequent reads from it will return its default value.
  mutating func clearExtStr() {self._extStr = nil}
...
extension SomeProtoWithBytes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "SomeProtoWithBytes"
  ...
  static func ==(lhs: SomeProtoWithBytes, rhs: SomeProtoWithBytes) -> Bool {
