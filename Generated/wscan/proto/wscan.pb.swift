...
struct Wscan_Request: @unchecked Sendable {
...
struct Wscan_Response: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Wscan_Responses: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var responses: [Wscan_Response] = []
...
fileprivate let _protobuf_package = "wscan"

extension Wscan_Request: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 8: try { try decoder.decodeSingularBytesField(value: &self.image) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.image.isEmpty {
      try visitor.visitSingularBytesField(value: self.image, fieldNumber: 8)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Wscan_Request, rhs: Wscan_Request) -> Bool {
...
extension Wscan_Response: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Wscan_Response, rhs: Wscan_Response) -> Bool {
    if lhs.uuid != rhs.uuid {return false}
    if lhs.prompt != rhs.prompt {return false}
    if lhs.context != rhs.context {return false}
    if lhs.message != rhs.message {return false}
...
extension Wscan_Responses: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Wscan_Responses, rhs: Wscan_Responses) -> Bool {
