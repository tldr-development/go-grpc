...
func (x *Request) GetCreated() string {
	if x != nil {
		return x.Created
	}
	return ""
...
func (x *Request) GetUpdated() string {
	if x != nil {
		return x.Updated
	}
	return ""
...
func (x *Response) GetTicket() string {
	if x != nil {
		return x.Ticket
	}
	return ""
...
var file_wallet_proto_wallet_proto_rawDesc = []byte{
	...
	0x69, 0x63, 0x6b, 0x65, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x74, 0x69, 0x63,
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x32, 0x90, 0x01, 0x0a,
