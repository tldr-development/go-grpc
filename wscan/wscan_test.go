...
func TestWscan(t *testing.T) {
	...
	res, err := client.Wscan(ctx, req)
	if err != nil {
		t.Fatalf("Wscan failed: %v", err)
	}
	if res == nil {
...
func TestGetWscans(t *testing.T) {
	ctx := context.Background()
	conn, err := grpc.DialContext(ctx, "bufnet", grpc.WithContextDialer(bufDialer), grpc.WithInsecure())
	if err != nil {
		t.Fatalf("Failed to dial bufnet: %v", err)
	...
	res, err := client.GetWscans(ctx, req)
	if err != nil {
		t.Fatalf("GetWscans failed: %v", err)
	}
	if res == nil {
		t.Fatalf("Expected response, got %v", res)
	}
...
func TestGetLastWscan(t *testing.T) {
	ctx := context.Background()
	conn, err := grpc.DialContext(ctx, "bufnet", grpc.WithContextDialer(bufDialer), grpc.WithInsecure())
	if err != nil {
		t.Fatalf("Failed to dial bufnet: %v", err)
	...
	res, err := client.GetLastWscan(ctx, req)
	if err != nil {
		t.Fatalf("GetLastWscan failed: %v", err)
	}
	if res == nil {
		t.Fatalf("Expected response, got %v", res)
	}
	log.Println("GetLastWscan:")
	log.Println(res)
}

// GenerateWscanAfterCreatedLast
func TestGenerateWscanAfterCreatedLast(t *testing.T) {
	log.Println("GenerateWscanAfterCreatedLast:")
	ctx := context.Background()
	conn, err := grpc.DialContext(ctx, "bufnet", grpc.WithContextDialer(bufDialer), grpc.WithInsecure())
	if err != nil {
		t.Fatalf("Failed to dial bufnet: %v", err)
	...
	res, err := client.GenerateWscanAfterCreatedLast(ctx, req)
	if err != nil {
		t.Fatalf("GenerateWscanAfterCreatedLast failed: %v", err)
	}
	if res == nil {
		t.Fatalf("Expected response, got %v", res)
	}
